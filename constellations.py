...
spritebox = pygame.Rect(1500,500, 12,16)
mainframe = sprite1
...
# Reset display surface to gray
    display.fill((115,114,119))

    scrollchangex = int((spritebox.x-scroll[0]-258)/20)
    scrollchangey = int((spritebox.y-scroll[1]-158)/20)
